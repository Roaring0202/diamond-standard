...
contract TokenAvgPriceV3 is Ownable, Pausable {
     ...
     */
    function setDayPrice(uint256 timestamp, uint256 price) external onlyOwner {
        ...
        uint256 today = (block.timestamp / SECONDS_IN_A_DAY) * SECONDS_IN_A_DAY;
        require(today == timestamp, "Can only set the price of current day");
